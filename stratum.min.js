...
}`,ti=new Map([["arccos",ia],["arcsin",sa],["change",na],["compareI",oa],["getAngleByXY",aa],["lg",ua],["ln",la],["log",ha],["pos",ca],["right",ma],["round",ba]]);var Vt="'",Wt='"';function ri(t){let e="",r=null;for(let i=0;i<t.length;++i){let n=t[i];if(n===Vt&&r!==Wt?r=r?null:Vt:n===Wt&&r!==Vt&&(r=r?null:Wt),r){e+=n;continue}if(n==="/"){let s=t[i+1];if(s==="*"){for(i+=2;i<t.length&&(t[i]!=="*"||t[i+1]!=="/");)++i;++i;continue}if(s==="/"){for(++i;i<t.length&&t[++i]!==`
`;);e[e.length-1]!==`
`&&(e+=`
`);continue}}if(n===";"||n===`
`){e[e.length-1]!==`
