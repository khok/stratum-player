...
}`,ti=new Map([["arccos",ia],["arcsin",sa],["change",na],["compareI",oa],["getAngleByXY",aa],["lg",ua],["ln",la],["log",ha],["pos",ca],["right",ma],["round",ba]]);var Vt="'",Ct='"';function ri(t){let e="",r=null;for(let i=0;i<t.length;++i){let n=t[i];if(n===Vt&&r!==Ct?r=r?null:Vt:n===Ct&&r!==Vt&&(r=r?null:Ct),r){e+=n;continue}if(n==="/"){let s=t[i+1];if(s==="*"){for(i+=2;i<t.length&&(t[i]!=="*"||t[i+1]!=="/");)++i;++i;continue}if(s==="/"){for(++i;i<t.length&&t[++i]!==`
`;);e[e.length-1]!==`
`&&(e+=`
`);continue}}if(n===";"||n===`
`){e[e.length-1]!==`
...
`?e:e+`
`}var ni=ta(si());var Ee=new Map;var pa=[gt,be,Ke,Z,ke],Qe=class{constructor(e,r,i,n){this.contextVars=null;this.target=null;this.lib=r;let s=ri(e),a;try{a=(0,ni.parse)(s)}catch(g){console.dir(g),console.log(s);let R=g.location.start;throw Error(`\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0430\u0440\u0441\u0438\u043D\u0433\u0430 ${i}, \u0441\u0442\u0440\u043E\u043A\u0430 ${R.line} \u0441\u0442\u043E\u043B\u0431\u0435\u0446 ${R.column}: ${g.message}`)}if(a.length===0){this._func=Qe.noModel,this.isFunction=!1,this.vars=[];return}let u;try{u=new Ut(a,r,n)}catch(g){throw console.log(s.split(`
...
`),S=u.missingFuncs;S.size>0&&console.warn(`\u0424\u0443\u043D\u043A\u0446\u0438\u0438 ${[...S.values()].join(", ")} \u0432 ${i} \u043D\u0435 \u0440\u0435\u0430\u043B\u0438\u0437\u043E\u0432\u0430\u043D\u044B.`),S.forEach((g,R)=>Ee.set(R,g));let f=c.join(`
